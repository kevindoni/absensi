...
<head>    <meta charset="utf-8">
    ...
    <meta name="description" content="Sistem Absensi - Guru Login">
    <meta name="author" content="">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>AbsensiPro - Guru Login</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Guru Login</h1>
                                    </div>
                                    <form class="user" method="POST" action="{{ route('guru.login') }}">
                                        @csrf
