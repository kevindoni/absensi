...
<head>    <meta charset="utf-8">
    ...
    <meta name="description" content="Sistem Absensi - Orang Tua Login">
    <meta name="author" content="">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>AbsensiPro - Orang Tua Login</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Orang Tua Login</h1>
                                    </div>
                                    <form class="user" method="POST" action="{{ route('orangtua.login') }}">
                                        @csrf
